...
for($j=1;$j<=$highestRow;$j++){//从第一行开始读取数据
	...
	//插入到数据库中的对应的表中
    $sql="INSERT INTO qinchabiao(xiangmu, hangshu, mianji,beizhu) VALUES (
	 '{$strs[0]}',
	 '{$strs[1]}',
	 '{$strs[2]}',
	 '{$strs[3]}'
...
<!--	<img width="680" height="433" src="./error/wrong_format.jpg">-->
	<p><a href="http://localhost/Flex/download_qinchabiao.php"><img width="66" height="66" src="./error/download.jpg"></a></p>
</div>
</body>
</html>
